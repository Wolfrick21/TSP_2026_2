...
public class AIManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Deteccion de enemigos en posicion de juagador
    ...
    //Metido para llevar a Player a la entrada
    ...
    //Metodo para calcular posisciciones validas
    Vector3 GetValidRandomPosition()
    {
        ...
        do
        {
            int i = random.Next(0, triangulation.indices.Length / 3);
    ...
    //Metodo para ubicar los objeto enemigo
    void FindAllEnemies()
    {
        agents.Clear();
